    ...
    .content-wrapper
      ...
      .form-wrapper
        .field-group
          ...
          .field.is-horizontal
            label.label 品牌
            span.content-txt(v-text="item.brand_name")
          .field.is-horizontal
            label.label 服务分类
      ...
      .btn-wrapper
        .button-group
          a.button.primary.large(v-if="item.is_sale === 2 && is_hidden !== 2", @click="setSelaState(1)") 上架
          a.button.primary.large(v-if="item.is_sale === 1 && is_hidden !== 2", @click="setSelaState(2)") 下架
...
<script>
  ...
  export default {
    ...
    mounted () {
      this.is_hidden = this.$route.query.is_hidden - 0
      this.getData()
    },
  }
</script>
