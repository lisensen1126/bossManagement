            ...
            tbody
              tr(v-for="item in data_list")
                td
                  .simple-td
                    .radio
                      input(type="radio", :id="item.brand_id", :value="item", name="modal" v-model="selected_item")
...
<script>
  ...
  export default {
    ...
    mixins: [ModalInteractions, Api, BrandApi, AdminApi, ImageScale, FilterTools],
    props: {
      id: {
        type: [String, Number],
      },
