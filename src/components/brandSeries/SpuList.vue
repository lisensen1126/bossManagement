<template lang="pug">
  .section-layout
    add-spu(v-if="show_add", v-model="show_add" @resolve="getName", :default-value="show_item", need-)
...
<script>
  ...
  import addSpu from '@/components/brandSeries/modal/addSpuModal'  // 添加Spu
  import imageScale from '@/mixins/utilities/imageScale'
  import SeriesApi from '@/mixins/modules/SeriesSupport'
  export default {
    name: 'SpuList',
    mixins: [imageScale, SeriesApi],
    components: {
      EmptyPage,
      addSpu,
    },
